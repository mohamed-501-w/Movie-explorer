...
export default function MovieHero({movie}){
    ...
    return (
        <Link to='/movie' 
        className="flex justify-center items-center shadow shadow-gr">
            ...
            <img 
            className="rounded-sm  mask-radial-from-30% mask-radial-to-95% mask-radial-at-right mask-l-from-50 mask-r-from-95% mask-b-from-98%" 
