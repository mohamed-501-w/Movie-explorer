    ...
    return (
        <div className="w-[80%] mx-auto mt-10 text-secondary text-xl font-bold">
            ...
            <div className="flex mb-3 items-center gap-3">
                ...
                className={clsx("px-3 rounded-full py-2 text-main2 border hover:bg-secondary transition-colors duration-300 hover:text-primary", currentActive === "mostPopularity" && "bg-secondary text-primary")}
                onClick={setMostPopular}>
                    Most
                </button>
                <button
                
                className={clsx("px-3 rounded-full py-2 text-main2 border hover:bg-secondary transition-colors duration-300 hover:text-primary", currentActive === "leastPopularity" && "bg-secondary text-primary")}
